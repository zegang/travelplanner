...
import DesktopLayout from '@/components/pc/LocationsOnMap.vue';
import MobileLayout from '@/components/mobile/LocationsOnMap.vue';
...
// 📌 Shared Interface (Exported for child components)
...
import staticTravelLocations from '@/stores/staticdata'
...
const { mapInstance, updateMap, loadBaiduScript, initBaiduMap } = useBaiduMap(
  travelLocations,
  useBaiduCoordinates,
  activeMarkerId,
  expandedLocationId,
